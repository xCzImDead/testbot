...
👑 *rules  『لعرض قوانين السيرفر بامبيد』 
  ...
  console.log(`Logged in as ${client.user.tag}!`);
         ...
         client.on('message', message => {
            if (message.content === 'السلام عليكم') {
              message.channel.send(' وِ عَ ـلَيّكمِ آلَسًسًـلَآمِ وِ رحً ـمِة آلَلَهِ تُعَ ـآلَى وِ بّـركآتُهِ:heart: [user]');
  ...
  console.log(`Logged in as ${client.user.tag}!`);
         ...
         client.on('message', message => {
            if (message.content === 'هلا') {
              message.channel.send(' هِلَآ بّـيّك:heart: [user]');
  ...
  console.log(`Logged in as ${client.user.tag}!`);
         ...
         client.on('message', message => {
            if (message.content === 'برب') {
              message.channel.send(' تُيّتُ لَآ تُطٌوِلَ عَ ـلَيّنٌآ:heart: [user]');
  ...
  console.log(`Logged in as ${client.user.tag}!`);
         ...
         client.on('message', message => {
            if (message.content === 'باك') {
              message.channel.send(' وِلَكمِ بّـآك مِنٌوِر يّآ عَ ـسًسًـلَ:heart: [user]');
